...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="page-head-content">
                <h1 class="page-title">Detail Real Estate</h1>               
            </div>
        </div>
    </div>
  </div>
  ...
  <div id="header_navigation">
    <div id="crumbs"><a href="http://vnfactory.xyz/real-estate">Real-estate</a> &nbsp;&nbsp;»&nbsp;&nbsp;  <span class="active">Name BDS</span>
    </div>  
  </div>
                      ...
                      <div class="light-slide-item">            
                          <div class="clearfix">
                              ...
                              <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                  <li data-thumb="admin_assets/assets/img/property-1/property1.jpg"> 
                                      <img src="admin_assets/assets/img/property-1/property1.jpg" />
                                  </li>
                                  <li data-thumb="admin_assets/assets/img/property-1/property2.jpg"> 
                                      <img src="admin_assets/assets/img/property-1/property3.jpg" />
                                  </li>
                                  <li data-thumb="admin_assets/assets/img/property-1/property3.jpg"> 
                                      <img src="admin_assets/assets/img/property-1/property3.jpg" />
                                  </li>
                                  <li data-thumb="admin_assets/assets/img/property-1/property4.jpg"> 
                                      <img src="admin_assets/assets/img/property-1/property4.jpg" />
                                  </li>                                         
                              </ul>
                          </div>
                      </div>
              ...
              <div class="col-md-4 p0">
                  <aside class="sidebar sidebar-property blog-asside-right">
                              ...
                              <div class="inner-wrapper">
                                  ...
                                  <div class="clear">
                                      <div class="col-xs-4 col-sm-4 dealer-face">
                                          <a href="">
                                              <img src="admin_assets/assets/img/client-face1.png" class="img-circle">
                                          </a>
                                      </div>
                              ...
                              <ul>
                                  <li>
                                      <div class="col-md-3 col-sm-3 col-xs-3 blg-thumb p0">
                                          <a href="#"><img src="admin_assets/assets/img/demo/small-property-2.jpg"></a>
                                  ...
                                  <li>
                                      <div class="col-md-3 col-sm-3  col-xs-3 blg-thumb p0">
                                          <a href="#"><img src="admin_assets/assets/img/demo/small-property-1.jpg"></a>
                                          <span class="property-seeker">
                                              <b class="b-1">A</b>
                                              <b class="b-2">S</b>
                                          </span>
                                  ...
                                  <li>
                                      <div class="col-md-3 col-sm-3 col-xs-3 blg-thumb p0">
                                          <a href="#"><img src="admin_assets/assets/img/demo/small-property-3.jpg"></a>
                                          <span class="property-seeker">
                                              <b class="b-1">A</b>
                                              <b class="b-2">S</b>
                                          </span>
                      ...
                      <div class="panel panel-default sidebar-menu wow fadeInRight animated">
                          ...
                          <div class="panel-body recent-property-widget">
                              <img src="admin_assets/assets/img/ads.jpg">
                          </div>
                      </div>
